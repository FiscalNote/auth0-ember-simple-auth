...
export default Base.extend({
  ...
  init: function() {
    ...
    if (this.get('defaultOptions')) {
      lock = new Auth0Lock(this.get('clientID'), this.get('domain'), this.get('defaultOptions'));
    } else {
      lock = new Auth0Lock(this.get('clientID'), this.get('domain'));
    }
